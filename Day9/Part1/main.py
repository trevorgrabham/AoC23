    ...
    with open("input.txt") as inputFile:
      ...
      for line in inputLines:
        ...
        for i in range(len(differenceLists)-1):
          differenceLists[length - 2 - i].append(differenceLists[length - 2 - i][-1] + differenceLists[length - 1 - i][-1])
        extrapolatedValues.append(differenceLists[0][-1])
        print(differenceLists[0][-1])
